public class N24RandomNumbers{
	public static void main(String[] args){
		int a, b, c, d;
		double r, rps;
		
		rps = Math.random();
		if (rps < .03333333){ //will be true 1/3 of the time
		...
		c = 1 + (int)((3-1+1)*Math.random());
		System.out.println( "1-3:\t" +a+ "\t" +b+ "\t" +c);
		
		//display 3 random numbers each 5-10
		System.out.println( "5-10:\t" +(5 + (int)(6*Math.random()))+ "\t" +(5 + (int)(6*Math.random()))+ "\t" +(5 + (int)(6*Math.random())));
	}
}